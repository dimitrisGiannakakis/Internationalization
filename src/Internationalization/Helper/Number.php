...
class Number
{
    ...
    public static function numberToCurrency($number, $options = array())
    {
        ...
        $defaults = i18n::translate("number.format", $params);
        #print_r($defaults);
        /**
         * Should return
         * array(
         ...
         * )
         */
        $currency = i18n::translate("number.currency.format", $params);
        /**
         * Should return
         * array(
         *  'unit' => '$',
    ...
    public static function numberToPercentage($number, $options = array())
    {
        ...
        $defaults = i18n::translate("number.format", $params);
        $percentage = i18n::translate("number.percentage.format");
    ...
    public static function numberWithPrecision($number, $options = array())
    {
        ...
        $defaults = i18n::translate("number.format", $params);
        $precision_defaults = i18n::translate('number.precision.format', $params);
